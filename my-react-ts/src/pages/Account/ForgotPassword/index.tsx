...
import {type IForgotPasswordRequest, useForgotPasswordMutation} from "../../../services/apiAccoount.ts";
...
const ForgotPasswordPage: React.FC = () => {
    ...
    const onFinish: FormProps<IForgotPasswordRequest>["onFinish"] = async (values: IForgotPasswordRequest) => {
        try {
